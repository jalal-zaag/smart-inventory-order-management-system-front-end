...
export default class RestockService {
    static getRestockQueue = params =>
        privateAPI.get(API_URL.GET_RESTOCK_QUEUE_URL, { params });

    static restockProduct = (id, data) =>
        privateAPI.post(API_URL.RESTOCK_PRODUCT_URL(id), data);

    static removeFromQueue = id =>
        privateAPI.delete(API_URL.REMOVE_FROM_QUEUE_URL(id));
}
